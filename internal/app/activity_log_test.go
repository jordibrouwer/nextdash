...
func TestActivityLogOpenDisabledByDefault(t *testing.T) {
	...
	lines := captureActivityLogs(t, func() {
		logBookmarkOpen(1, 0, Bookmark{Name: "HN", URL: "https://news.ycombinator.com"}, "", "", "", nil, nil)
	})
	if len(lines) != 0 {
...
func TestActivityLogOpenWhenEnabled(t *testing.T) {
	...
	lines := captureActivityLogs(t, func() {
		logBookmarkOpen(1, 2, Bookmark{PageID: 1, Name: "HN", URL: "https://news.ycombinator.com"}, "", "", "", nil, nil)
	})
