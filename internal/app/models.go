...
type ThemeColors struct {
	...
	// surface, 0 to 1. Zero is the flat edge every theme has today.
...
func getDefaultBuiltInThemes() map[string]ThemeColors {
	return map[string]ThemeColors{
		...
		"nocturne-ink-dark":   {Name: "Nocturne Ink [dark]", TextPrimary: "#F5F3EF", TextSecondary: "#C6C2B9", TextTertiary: "#8E8A82", BackgroundPrimary: "#08090B", BackgroundSecondary: "#101216", BackgroundDots: "#1A1D22", BackgroundModal: "rgba(8, 9, 11, 0.92)", BorderPrimary: "#23262C", BorderSecondary: "#191C21", AccentPrimary: "#E4B363", AccentSuccess: "#7FB069", AccentWarning: "#E0A458", AccentError: "#D45D5D", RadiusScale: 0.5, LabelSpacing: "0.005em", LabelWeight: 500},
		"nocturne-ink-light":  {Name: "Nocturne Ink [light]", TextPrimary: "#17181B", TextSecondary: "#4A4B50", TextTertiary: "#75767C", BackgroundPrimary: "#FCFBF9", BackgroundSecondary: "#F2F1EC", BackgroundDots: "#E3E2DB", BackgroundModal: "rgba(252, 251, 249, 0.93)", BorderPrimary: "#DEDCD4", BorderSecondary: "#EAE8E1", AccentPrimary: "#9A6B1F", AccentSuccess: "#4A7A38", AccentWarning: "#9A6B1F", AccentError: "#A63D3D", RadiusScale: 0.5, LabelSpacing: "0.005em", LabelWeight: 500},
		...
		"porcelain-dark":      {Name: "Porcelain [dark]", TextPrimary: "#F2EFE8", TextSecondary: "#C2BDB2", TextTertiary: "#8C877C", BackgroundPrimary: "#16150F", BackgroundSecondary: "#1F1E17", BackgroundDots: "#2A2820", BackgroundModal: "rgba(22, 21, 15, 0.92)", BorderPrimary: "#332F26", BorderSecondary: "#25231C", AccentPrimary: "#7FC0AC", AccentSuccess: "#7FC0AC", AccentWarning: "#D6A75A", AccentError: "#D97070", RadiusScale: 0.8, LabelSpacing: "0.01em", LabelWeight: 600},
		"porcelain-light":     {Name: "Porcelain [light]", TextPrimary: "#22201C", TextSecondary: "#56524A", TextTertiary: "#8B857A", BackgroundPrimary: "#FBFAF7", BackgroundSecondary: "#F1EFE9", BackgroundDots: "#E4E1D8", BackgroundModal: "rgba(251, 250, 247, 0.93)", BorderPrimary: "#E2DED4", BorderSecondary: "#EDEAE2", AccentPrimary: "#2F6F5E", AccentSuccess: "#2F6F5E", AccentWarning: "#9A6B1F", AccentError: "#A33A3A", RadiusScale: 0.8, LabelSpacing: "0.01em", LabelWeight: 600},
		/*
