...
- **Tab shell (v2026.06.31 / v2026.07.01 / v2026.07.01.1 / v2026.07.01.4 / v2026.07.01.5 / v2026.07.01.8)** — list tabs (Pages, Categories, Tags, Finders, Collections) share the same intro paragraph, toolbar alignment, search/filter field, and empty-state layout (`config-list-tab`, **v2026.07.01.5**). **Pages** and **Categories** also show a **Usage** column (popularity bar + bookmark count, like Tags) (**v2026.07.01.4**). **Bookmarks** Context and **Collections** editor sit inside their fused surfaces (**v2026.07.01.5**). **Keyboard**, **Bookmarks**, **Stats**, **Backups**, and **Help** use the fused `config-tab-surface` pattern. On **Classic**, **Modern**, and **Glass**, each tab fuses toolbar + content into one surface card with divided rows. Intro text keeps consistent spacing above toolbars on General, Bookmarks, and list tabs. Config chrome respects `prefers-reduced-motion` (**v2026.07.01.4**); tag cloud, keyboard pulse, health shimmer, and settings-search promo animations also respect it (**v2026.07.01.8** / C15). Unsaved group dots include **Extras ●** when only **Collections** changes (**v2026.07.01.8** / C14).
...
- **In-app What's new (★)** — Latest release highlights first; scroll for up to **20 recent** versions (each loads on demand with a skeleton while fetching)  
