...
**After v2026.08.06** — there was no in-app way to learn about a newer GitHub release without opening release notes yourself; release web push was noisy and often missed.
...
- **fix** — What's new modal, **Config → Overview → Latest update**, New features carousel, CHANGELOG, README, MANUAL, and Config → Help **What's new** recap for **v2026.08.07**; `DASHBOARD_RELEASE` → `2026.07-dashboard-release-v157`, `NEXTDASH_WHATS_NEW_DATA_VERSION` → `whats-new-v215`.
