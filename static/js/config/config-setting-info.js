...
const SETTING_INFO_DEFS = [
    ...
    { type: 'checkbox', targetId: 'show-tips-checkbox', btnId: 'show-tips-info-btn', title: 'showTipsInfoTitle', message: 'showTipsInfoMessage' },
    ...
    { type: 'checkbox', targetId: 'show-search-flow-banner-checkbox', btnId: 'show-search-flow-banner-info-btn', title: 'showSearchFlowBannerInfoTitle', message: 'showSearchFlowBannerInfoMessage' },
    { type: 'checkbox', targetId: 'include-finders-in-search-checkbox', btnId: 'include-finders-in-search-info-btn', title: 'includeFindersInSearchInfoTitle', message: 'includeFindersInSearchInfoMessage' },
    { type: 'checkbox', targetId: 'skip-fast-ping-checkbox', btnId: 'skip-fast-ping-info-btn', title: 'skipFastPingInfoTitle', message: 'skipFastPingInfoMessage' },
    { type: 'checkbox', targetId: 'show-sync-toasts-checkbox', btnId: 'show-sync-toasts-info-btn', title: 'showSyncToastsInfoTitle', message: 'showSyncToastsInfoMessage' },
    { type: 'checkbox', targetId: 'hide-empty-categories-checkbox', btnId: 'hide-empty-categories-info-btn', title: 'hideEmptyCategoriesInfoTitle', message: 'hideEmptyCategoriesInfoMessage' },
    { type: 'checkbox', targetId: 'always-collapse-categories-checkbox', btnId: 'always-collapse-categories-info-btn', title: 'alwaysCollapseCategoriesInfoTitle', message: 'alwaysCollapseCategoriesInfoMessage' },
    { type: 'checkbox', targetId: 'global-shortcuts-checkbox', btnId: 'global-shortcuts-info-btn', title: 'globalShortcutsInfoTitle', message: 'globalShortcutsInfoMessage' },
