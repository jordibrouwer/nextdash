...
(function () {
    ...
    /*
     * The two tokens do different jobs, and both move for v1.9.0.
     *
     ...
     * release the modal leads with, which is v1.9.0 — nothing is held back.
     *
     ...
     * read the index keeps its copy and never learns v1.10.0 exists.
     */
    const DASHBOARD_RELEASE = '2026.09-dashboard-release-v1.12.0';
    ...
    window.NEXTDASH_WHATS_NEW_DATA_VERSION = 'whats-new-v291';
