...
(function () {
    ...
    const DASHBOARD_RELEASE = '2026.06-dashboard-release-v69';
    ...
    const MODAL_SCRIPT_URL = '/static/js/whats-new-modal.js?v=whats-new-v88';

    window.NEXTDASH_WHATS_NEW_RELEASE = DASHBOARD_RELEASE;
    window.NEXTDASH_WHATS_NEW_DATA_VERSION = 'whats-new-v88';
