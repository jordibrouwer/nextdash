...
(function () {
     ...
     * v1.4.2 through v1.4.2.1 and v1.4.2.2, both of which carry
     ...
     * index keeps its copy and never learns v1.4.2.2 exists at all.
     */
    ...
    window.NEXTDASH_WHATS_NEW_DATA_VERSION = 'whats-new-v263';
