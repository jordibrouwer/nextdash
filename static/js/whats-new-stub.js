...
(function () {
    ...
    /*
     * The two tokens do different jobs, and both move for v1.13.2.
     *
     ...
     * release the modal leads with, which is v1.13.2 — v1.13.1 is held back and
     * so was never what this named.
     *
     ...
     * read the index keeps its copy and never learns v1.13.2 exists.
     */
    const DASHBOARD_RELEASE = '2026.09-dashboard-release-v1.13.2';
    ...
    window.NEXTDASH_WHATS_NEW_DATA_VERSION = 'whats-new-v298';
