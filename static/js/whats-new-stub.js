...
(function () {
     ...
     * read the index keeps its copy and never learns v1.9.0 exists.
     */
    const DASHBOARD_RELEASE = '2026.09-dashboard-release-v1.9.0';
    ...
    window.NEXTDASH_WHATS_NEW_DATA_VERSION = 'whats-new-v284';
