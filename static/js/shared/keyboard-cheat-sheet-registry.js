    ...
    const SECTIONS = [
        {
            ...
            rows: [
                ...
                {
                    keys: 'Shift + A',
                    cheatKey: 'navThemeBrowser',
                    fallback: 'Open the theme browser — pick or preview a theme without opening config',
                    when: (ctx) => ctx.configEnabled,
                    print: true,
                    printFallback: 'Open the theme browser',
                },
        ...
        },
        {
            ...
            rows: [
                ...
                { keys: '↑ / ↓ (list rows)', cheatKey: 'cvListMove', fallback: 'Move between rows when focus is in the list panel — the Structure lists and Bookmarks → Tags' },
