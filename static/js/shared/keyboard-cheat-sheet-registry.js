    ...
    const SECTIONS = [
        ...
        },
        {
            ...
            rows: [
                ...
                { keys: 'Ctrl/Cmd + Enter', cheatKey: 'bmOpenNewTab', fallback: 'Open the focused bookmark in a new tab, whatever the open-in-new-tab setting says' },
                ...
                { keys: 'Shift + S', cheatKey: 'bmShare', fallback: 'Share the focused bookmark, or copy its name and URL where no share sheet exists' },
                { keys: 'Shift + R', cheatKey: 'bmRevealHealth', fallback: 'Open the focused bookmark on its own row in Health' },
                { keys: 't', cheatKey: 'bmFilterTag', fallback: 'Filter the grid to the focused bookmark\u2019s tag; several tags open the picker' },
