    ...
    const SECTIONS = [
        {
            ...
            rows: [
                ...
                { keys: '↑ / ↓  ·  k / j', cheatKey: 'navFocusUpDown', fallback: 'Move focus up / down through bookmarks', print: true, printKeys: '↑ ↓ ← →', printFallback: 'Move focus' },
                ...
                { keys: 'Shift + Home', cheatKey: 'navCategoryHeader', fallback: 'Jump from the list up to its category header, where F2, Shift+W and the menu live' },
        ...
        },
        {
            ...
            rows: [
                ...
                { keys: 'Shift + E', cheatKey: 'bmInlineEdit', fallback: 'Inline-edit focused bookmark' },
