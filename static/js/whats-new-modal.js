            ...
            release('v2026.06.15', 'June 2026', '2026-06-10', [
                {
                    ...
                    items: [
                        ...
                        { badge: 'fix', text: '<strong>Post-onboarding chain hardening</strong> — What\'s new retries when blocked instead of skipping for the session; polling capped after ~30s; open-abort retries capped at 20; layout nudge reset from config runs the full chain again (not layout-only).' },
                        { badge: 'fix', text: '<strong>isModalOpen visibility</strong> — post-onboarding prompts only wait for actually visible overlays, not stale DOM or <code>guided-flow-locked</code> alone.' },
                    ]
                },
                {
                    ...
                    items: [
                        ...
                        { badge: 'fix', text: '<strong>Guided flow invisible overlays</strong> — onboarding and feature-tour overlays use the same visibility check (not only config tour cards).' },
                    ]
                },
                {
                    ...
                    items: [
                        ...
                        { badge: 'fix', text: '<strong>Paste spotlight replay</strong> — reset from config queues a replay when no dashboard tab is open; dashboard init consumes the pending flag and runs the post-onboarding chain.' },
                    ]
                },
                {
                    title: 'Config &amp; search',
                    items: [
                        ...
                        { badge: 'fix', text: '<strong>Settings search desktop→mobile resize</strong> — hides the search field and dismisses the promo when narrowing the config window.' },
