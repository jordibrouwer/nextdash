            ...
            release('v2026.06.13', 'June 2026', '2026-06-09', [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { badge: 'new', text: '<strong>Discoverability queue bar</strong> — layout-versions and paste spotlights show <em>Tip X of Y</em> and <em>Later this session</em>; defer skips remaining post-onboarding prompts this session.' },
                    ]
                },
                {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { badge: 'fix', text: '<strong>What\'s new script cache bust</strong> — <code>whats-new-modal.js?v=whats-new-v51</code> on dashboard and config so release-note updates load without a hard refresh.' },
                        { badge: 'fix', text: '<strong>Repo hygiene</strong> — <code>.gitignore</code> merge conflict resolved; <code>node_modules/</code> removed from git; Playwright stays a <code>devDependency</code> for local debug scripts only.' },
                    ]
                },
            ]),
